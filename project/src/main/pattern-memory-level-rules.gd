...
func add_cards() -> void:
	...
	match puzzle_difficulty:
		0:
			...
			_allowed_hidden_lizard_count = _random.randi_range(1, 2)
			_shark_chance = 0.3
		1:
			fill_in_sides = true
			_cards_to_hide = 3
			_remaining_cards_without_hiding = 2
			_allowed_hidden_lizard_count = _random.randi_range(0, 2)
			_shark_chance = 0.4
		2:
			fill_in_sides = true
		3:
		...
		4:
			_remaining_cards_without_hiding = 2
			_cards_to_hide = 1
			_allowed_hidden_lizard_count = _random.randi_range(2, 4)
			shark_percent = 0.60
			_shark_chance = 0.4
		5:
			_cards_to_hide = 1
		...
		6:
			_cards_to_hide = 1
			_allowed_hidden_lizard_count = _random.randi_range(0, 1)
			shark_percent = 0.60
			_shark_chance = 0.6
		7:
			_cards_to_hide = 2
